package com.veltech.views.main;

import com.veltech.PointOfInterest;
import com.veltech.PointsOfInterestResponse;
...
import com.veltech.TripsAdvisorService;
...
public class PointsOfInterestView extends VerticalLayout {
    ...
    public PointsOfInterestView(TripsAdvisorService tripsAdvisorService) {
        ...
        Label title = new Label("Travel Budget Advisor");
